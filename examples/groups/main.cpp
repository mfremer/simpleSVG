...
int main() {
    /* Same as elliptical_arc/main.cpp up to... */
    ...
    // Separate red and green paths (longer arcs) into one group
    file.begin_group("Outside arcs");
    file << path_red;
    file << path_green;
    file.end_group();
    
    // Separate blue and magenta paths (shorter arcs) into another group
    file.begin_group("Inside arcs");
    file << path_blue;
    file << path_magenta;
    file.end_group();

    file.write_file("./groups.svg");
